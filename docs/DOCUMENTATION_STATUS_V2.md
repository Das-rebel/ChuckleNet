...
| `docs/PICLI_EXECUTION_MANDATE_V2.md` | **current Pi CLI execution control plane** |
...
- `docs/PICLI_EXECUTION_MANDATE_V1.md` — superseded by V2; retained for provenance
...
`repository archaeology → E01 robust event validation → E02 temporal information gain → E03 semantic increment → E04 cross-domain transfer → E05 multimodal expansion`
...
7. Pi CLI should prefer the smallest experiment that can falsify or strengthen the active hypothesis.
8. New model complexity requires a stated hypothesis-level reason.
9. Commercial claims must distinguish discovery, design partnership, pilot evidence and paid revenue.
