...
1. **Extract pause features** — Purandare 2006: 0.8s threshold before laughter
2. **Verify prosody alignment** — all video_id + start timestamps match prosody cache
3. **Run Stage 1 text-only baseline** — establish region detection F1
