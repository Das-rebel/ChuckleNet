# ChuckleNet — Pi CLI Execution Mandate V4

**Status: CANONICAL EXECUTION CONTROL PLANE**  
**Date:** 2026-09-15  
**Supersedes for execution:** `PICLI_EXECUTION_MANDATE_V3.md`  
...
The old broad sequence is compressed into five priorities:
...
4. weak-label 620-video v32 result;
...
`docs/CURRENT_EVIDENCE_AUDIT_2026-09-15.md`
...
- `docs/PICLI_EXECUTION_MANDATE_V3.md`
- the latest canonical paper and supporting results registry

Then do **only**:

1. repository archaeology for the six current evidence anchors;
2. produce `docs/CURRENT_EVIDENCE_AUDIT_2026-09-15.md`;
3. identify exact reusable code/artifacts for P1;
4. design P1 as a reproducible paired/counterfactual test;
5. execute P1 if all required assets exist;
6. write the P1 decision memo;
7. stop and report before starting P2.
